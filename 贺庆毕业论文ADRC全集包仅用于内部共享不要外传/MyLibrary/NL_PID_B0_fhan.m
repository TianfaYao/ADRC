function [sys,x0,str,ts]=NL_PID_B0_fhan(t,x,u,flag,r0,h0,r1,h1,h,Bet0,r2,h2)
switch flag,
    case 0,
...
function sys=mdlUpdates(x,u,r0,r1,h0,h1,h)
    ...
    x(5)=x(5)+h*(x(1)-x(3));
    sys=x;
function sys=mdlOutputs(x,Bet0,r2,h2)   
    sys(1)=Bet0*x(5)-fhan(x(1)-x(3),x(2)-x(4),r2,h2)    
    sys(2)=x(1);
